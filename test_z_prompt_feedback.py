...
from prompt_feedback import feedback_on_executions, CODE_9565186b, CODE_9565186b_bad
...
def test_feedback_on_bad_code():
    ...
    rr_train = (rr, execution_outcomes, exception_message)
    output = feedback_on_executions(rr_train)
    assert "You had no examples that executed, your code is bad and must be fixed" in output
